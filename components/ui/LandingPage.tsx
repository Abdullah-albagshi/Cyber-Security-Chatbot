  ...
  return (
    <div className="grid-container">
      ...
      <div className="pageLeft">
        <Image
          src="https://raw.githubusercontent.com/0xw01f/cybersecurity-landing-page/0f46d4269f64a3dd9a5c6826b631a985e4a0f1ff/images/techLeft.svg"
          height="500"
          width="300"
          alt='techLeft'
        />
      ...
      <div className="pageRight">
        <Image
          src="https://raw.githubusercontent.com/0xw01f/cybersecurity-landing-page/0f46d4269f64a3dd9a5c6826b631a985e4a0f1ff/images/techRight.svg"
          height="430"
          width="230"
          alt='techRight'
        />
